...
class ConversationMessage(Base):
    ...
    @classmethod
    def from_conversation_item(cls, conversation_id: str, item, message_type: str = None):
        """
        ...
        if isinstance(item, dict):
            ...
            additional_data = {k: v for k, v in item.items() if k not in [
                'role', 'content', 'tool_name', 'tool_success']}

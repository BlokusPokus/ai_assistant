...
def upgrade():
    ...
    op.add_column('users', sa.Column(
        'is_active', sa.Boolean(), nullable=True, default=True))
    op.add_column('users', sa.Column(
    ...
    op.add_column('users', sa.Column(
        'password_reset_expires', sa.DateTime(), nullable=True))
    op.add_column('users', sa.Column(
        'last_login', sa.DateTime(), nullable=True))
    op.add_column('users', sa.Column('failed_login_attempts',
    ...
    op.add_column('auth_tokens', sa.Column(
        'token_type', sa.String(), nullable=True, default='refresh'))
    op.add_column('auth_tokens', sa.Column(
        'is_revoked', sa.Boolean(), nullable=True, default=False))
    op.add_column('auth_tokens', sa.Column(
    ...
    op.create_unique_constraint(
        'uq_auth_tokens_token', 'auth_tokens', ['token'])

...
#     try:
#         # Check if we should use normalized storage
#         from ..config.feature_flags import use_normalized_storage
...
#                 logger.debug(
#                     f"Successfully loaded timestamp from old storage for conversation {conversation_id} and user {user_id}: {timestamp}")
#                 return timestamp

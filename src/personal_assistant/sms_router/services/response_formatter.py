...
class ResponseFormatter:
    ...
    def __init__(self):
        ...
        self.max_concatenated_length = 1600  # 10 SMS segments
    ...
    def format_response(self, agent_response: str, user_info: Dict[str, Any]) -> MessagingResponse:
        ...
        try:
            ...
            logger.info(f"Formatted response for user {user_info['id']}: {len(formatted_text)} chars")
            return response
            ...
            fallback_response.message("I'm sorry, there was an error processing your request. Please try again.")

...
def validate_twilio_signature(request: Request, auth_token: str, signature: str, 
                            url: str, params: dict) -> bool:
    """
...
def rate_limit_check(request: Request, max_requests: int = 60, window_seconds: int = 60) -> bool:
    """

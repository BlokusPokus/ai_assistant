...
class OAuthScope(Base):
    ...
    provider = Column(String(50), nullable=False)  # google, microsoft, notion, youtube
    scope_name = Column(String(100), nullable=False)  # e.g., 'calendar.readonly', 'drive.readwrite'
    ...
    is_readonly = Column(Boolean, default=True)  # Whether scope allows write access
    is_required = Column(Boolean, default=False)  # Whether scope is required for basic functionality

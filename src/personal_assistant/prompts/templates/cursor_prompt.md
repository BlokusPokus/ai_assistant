...
bug that give info on the structure of cursor:

<invoke name="edit_file">
<parameter name="target_file">src/personal_assistant/prompts/MAS.MD</parameter>
<parameter name="instructions">I will add a new section about SMS scaling challenges and solutions in the strategic architecture section, addressing the critical decision about how multiple users will get SMS access.</parameter>
<parameter name="code_edit">## 4.0.3 Défis d'évolutivité SMS et solutions

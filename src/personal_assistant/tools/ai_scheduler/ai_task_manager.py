...
class AITaskManager:
    ...
    async def create_task(
        ...
        async with AsyncSessionLocal() as session:
            try:
                ...
                self.logger.info(
                    f"Created AI task: {task.title} (ID: {task.id})")
                return task
    ...
    def _serialize_schedule_config(self, schedule_config: Dict[str, Any]) -> Dict[str, Any]:
        """
    ...
    async def delete_task(self, task_id: int, user_id: int) -> bool:
        ...
        async with AsyncSessionLocal() as session:
            try:
                ...
                if not task:
                    self.logger.warning(
                        f"Task not found or unauthorized: {task_id}")
                    return False

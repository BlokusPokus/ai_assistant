  ...
  return (
    <div className="min-h-screen relative overflow-hidden bg-white">
      ...
      <div className="fixed inset-0 pointer-events-none">
        ...
        <div
          className="absolute top-0 left-0 w-[500px] h-[350px] blur-3xl animate-pulse"
          style={{
        ...
        ></div>
        <div
          className="absolute top-0 right-0 w-[700px] h-[500px] blur-3xl animate-pulse"
          style={{
        ...
        ></div>
        <div
          className="absolute bottom-0 left-0 w-[750px] h-[550px] blur-3xl animate-pulse"
          style={{
        ...
        ></div>
        <div
          className="absolute bottom-0 right-0 w-[650px] h-[450px] blur-3xl animate-pulse"
          style={{
      ...
      <div className="relative z-10 max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
        <div className="space-y-6">
          {/* Welcome Section */}
          <Card className="bg-gradient-to-r from-[#1a4835] to-[#98a758] text-white border-0">
